...
{
    public class ZeBeiWanWuSkill : BaseSkill
    {
        // 对友方单位施加治愈状态，回合结束时，恢复8160+7.4%的生命值,若已倒地则恢复生命值后状态消失，目标数4人,持续2个，对已倒地队友释放无效
        public ZeBeiWanWuSkill() : base(SkillId.ZeBeiWanWu, "泽被万物")
        {
        ...
        public override SkillEffectData GetEffectData(GetEffectDataRequest request)
        {
            ...
            var effectData = new SkillEffectData
            {
                ...
                // 目标单元
                TargetNum = 4 + (request.Member.HasBuff(SkillType.BianShen) ? new Random().Next(3) + 1 : 0),
            };
            return effectData;
        }
    }
