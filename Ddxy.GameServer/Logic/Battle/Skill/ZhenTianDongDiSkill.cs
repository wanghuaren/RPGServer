...
{
    public class ZhenTianDongDiSkill : BaseSkill
    {
        // 提升自身命中、破防概率与破防程度对敌方5个单位进行物理攻击。
        public ZhenTianDongDiSkill() : base(SkillId.ZhenTianDongDi, "震天动地")
        {
        ...
        public override SkillEffectData GetEffectData(GetEffectDataRequest request)
        {
            ...
            {
                // 目标单元
                TargetNum = 5 + (request.Member.HasBuff(SkillType.BianShen) ? new Random().Next(3) + 1 : 0)
            };
            // 技能基础伤害
