...
{
    public class FengYinSkill : BaseSkill
    {
        public FengYinSkill() : base(SkillId.FengYin, "封印")
        {
            Kind = SkillId.FengYin;
            Type = SkillType.Seal;
        ...
        public override SkillEffectData GetEffectData(GetEffectDataRequest request)
        {
            ...
            if (rate <= percent) effectData.SkillId = SkillId.ZuoBiShangGuan;
            return effectData;
        }
    }
}